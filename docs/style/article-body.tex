...
\subsubsection{5.3 Evaluation}\label{evaluation}}
>>>>>>> b76749ac919009487f9b43ad6b73de6985ac1ddb
...
\textbackslash begin\{table\}{[}ht{]}begin\{tabular\}\{\textbar c\textbar c\textbar c\textbar\} \hline \textbf{Bit size} \& \multicolumn{1}{c|}{\textbf{Teensy ($\mu s$)}} \& \multicolumn{1}{c|}{\textbf{Pico ($\mu s$)}} \textbackslash{} \hline 64 \& 13.1564 \& 106.3914 \textbackslash{} 512 \& 788.3139 \& 5302.4979 \textbackslash{} 1024 \& 3124.0580 \& 21111.2163 \textbackslash{} \hline

\caption{A brief overview of the testscript architecture.} \label{tab:iter1}

\textbackslash end\{tabular\} \label{tab:iter1}/end\{table\}
