...
Författarnamnen kommer så småningom att flyttas över till ett särskilt försättsblad inför slutlig publicering i DiVA. Det kan dock vara bra att ha med författarnamnen redan under tiden som rapporten utarbetas. Det kommer även att behövs skrivas ett abstract, som även den kommer att läggas på ett försättsblad. Själva den 10-sidiga exjobbsrapporten ska dock formateras enligt denna template.

Som ni ser så får man jobba lite med att placera sina figurer, eftersom \LaTeX enligt här mallen vill lägga figurerna längst upp eller längst ner på en sida.

We ask that authors follow some
